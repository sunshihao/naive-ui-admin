              ...
              <div class="form-group col-xs-12">
                ...
                <div class="col-xs-3">
                  <input
                    ...
                    @click="
                      () => {
                        cashierconfirm.companytree.showOrgTree();
                        return false;
                      }
                    "
                  />
                ...
                <div class="col-xs-2">
                  <input
                    ...
                    @click="
                      () => {
                        cashierconfirm.orgtree.showOrgTree();
                        return false;
                      }
                    "
                  />
            ...
            <div class="panel-body">
              <div class="form-group col-xs-12">
                ...
                <div class="col-xs-2">
                  <input
                    type="text"
                    class="laydate-icon-default ilead-laydate-icon-default"
                    id="starttime"
                    name="endtime"
                    placeholder="起始"
      ...
      <div class="col-xs-12 ilead-table">
        <div class="table-tool">
          <button
            ...
            data-placement="top"
            title="详细"
            @click="cashierconfirm.queryDetail('cashier')"
            id="detailBtn"
          >
          ...
          <button
            ...
            data-placement="top"
            title="详细"
            @click="cashierconfirm.queryDetail('detail')"
            id="detailBtn"
          >
          ...
          <button
            ...
            data-placement="top"
            title="确认"
            @click="cashierconfirm.doConfirm()"
            id="comfirmBtn"
          >
