  ...
  return {
        ...
        gridComplete: function () {
          ...
          for (var i = 0; i < ids.length; i++) {
            ...
            if (type == 'BX') {
              ...
              var btn =
                "<a id='view' href='javascript:void(0);'  onclick=\"doAppStatusFlow('银行间转款','" +
                id +
                "','FEE03001');\">审批通过</a>";
              jQuery('#dataList').jqGrid('setRowData', ids[i], { appStatus: btn });
            } else if (type == 'FX') {
              var btn =
                "<a id='view' href='javascript:void(0);'  onclick=\"doAppStatusFlow('付款报销','" +
                id +
                "','FEE02001');\">审批通过</a>";
              jQuery('#dataList').jqGrid('setRowData', ids[i], { appStatus: btn });
            } else if (type == 'CX') {
              ...
              var btn =
                "<a id='view' href='javascript:void(0);'  onclick=\"doAppStatusFlow('理财产品','" +
                id +
                "','FEE03002');\">审批通过</a>";
              jQuery('#dataList').jqGrid('setRowData', ids[i], { appStatus: btn });
            } else if (type == 'XC') {
              var btn =
                "<a id='view' href='javascript:void(0);'  onclick=\"doAppStatusFlow('薪酬发放','" +
                id +
                "','FEE03003');\">审批通过</a>";
              jQuery('#dataList').jqGrid('setRowData', ids[i], { appStatus: btn });
            }
    ...
    queryDetail: function (actionType) {
      ...
      if (type == 'BX') {
        ...
        url =
          WEB_CTX_PATH +
          '/tripMainAction.do?method=detail&actionType=' +
          actionType +
          '&paramId=' +
          paramIdArr[0];
        //					jQuery().openDlg({
        ...
        url =
          WEB_CTX_PATH +
          '/bankTransferAction.do?method=doAddOrEdit&actionType=' +
          actionType +
          '&billUid=' +
          paramIdArr[0];
        //					jQuery().openDlg({
        ...
        url =
          WEB_CTX_PATH +
          '/financingAction.do?method=doAddOrEdit&actionType=' +
          actionType +
          '&billUid=' +
          paramIdArr[0];
      } else if (type == 'XC') {
        ...
        url =
          WEB_CTX_PATH +
          '/salaryAction.do?method=doEditOrDetail&actionType=' +
          actionType +
          '&billUid=' +
          paramIdArr[0];
      } else {
