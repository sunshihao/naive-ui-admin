              ...
              <div class="form-group col-xs-12">
                ...
                <div class="col-xs-3">
                  <input
                    ...
                    readonly
                    placeholder="公司名称"
                    onclick="deptbill.deptbillList.companytree.showOrgTree(); return false;"
                  />
                ...
                <div class="col-xs-2">
                  <input
                    ...
                    readonly
                    placeholder="部门名称"
                    onclick="deptbill.deptbillList.orgtree.showOrgTree(); return false;"
                  />
      ...
      <div class="col-xs-12 ilead-table">
        <div class="table-tool">
          <button
            ...
            data-placement="top"
            title="详细"
            onclick="deptbill.deptbillList.queryDetail()"
            id="detailBtn"
          >
          ...
          <button
            ...
            data-placement="top"
            title="打印"
            onclick="deptbill.deptbillList.doPrint()"
            id="printBtn"
          >
...
<script setup>
  ...
  onMounted(() => {
    ...
    jQuery(document).ready(function () {
      deptbill.deptbillList.init();
      // 初始公司
      deptbill.deptbillList.companytree.init();
      //初始化控件
