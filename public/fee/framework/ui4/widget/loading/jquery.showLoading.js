...
//		//
//		border_top_width = isNaN(parseInt(border_top_width)) ? 0
//				: border_top_width;
//		border_left_width = isNaN(parseInt(border_left_width)) ? 0
//				: border_left_width;
//
//		var overlay_left_pos = $(this).offset().left
...
//		} else {
//			overlay_width = parseInt($(this).width())
...
//		} else {
//			overlay_height = parseInt($(this).height())
...
//			$(loadingDiv).css(
//					'left',
//					(indicatorLeft + (($(overlayDiv).width() - parseInt($(
...
//					.css(
//							'left',
//							(indicatorLeft + parseInt($(overlayDiv).css(
...
//					.css(
//							'left',
//							(indicatorLeft + parseInt(settings.hPos))
//									.toString()
//									+ 'px');
//		}
//
...
//			$(loadingDiv).css(
//					'top',
//					(indicatorTop + (($(overlayDiv).height() - parseInt($(
...
//		}
		...
		//适应各种页面加载场景 20140728
//		$(loadingDiv).css('top', ((document.body.clientHeight-80)/2).toString() + 'px');
//		$(loadingDiv).css('left', ((document.body.clientWidth-80)/2).toString() + 'px');
		
		$(loadingDiv).css('top', ((document.body.scrollHeight-80)/2).toString() + 'px');
		$(loadingDiv).css('left', ((document.body.scrollWidth-80)/2).toString() + 'px');
//		$(loadingDiv).css('top', '50%');
//		$(loadingDiv).css('left', '50%');
	...
	$.fn.hideLoading = function(options) {
		...
		$(document.body).find('#loading-indicator-' + indicatorID + '-overlay')
				.remove();
