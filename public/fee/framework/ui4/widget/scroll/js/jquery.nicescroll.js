      ...
      if (!self.ispage || (!cap.cantouch && !cap.isieold && !cap.isie9mobile)) {
        ...
        if (cap.isie9mobile) {
          ...
          self.onmousedown = function(e, hronly) {
            ...
            //add by zrzdemon 修改IE8下拖动滚动条问题
            if(cap.isie8){
	            self.mousedownAction = "1";
	            $("#ascrail2000").on("mousemove",function(){
	            });
	            $("#ascrail2000").on("mouseleave",function(){
	            	self.mousedownAction = "2";
	            });
            }
